...
// DSAApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDSAAppApp, CWinApp)
...
// Единственный объект CDSAAppApp

CDSAAppApp theApp;


// Инициализация CDSAAppApp

BOOL CDSAAppApp::InitInstance()
{
