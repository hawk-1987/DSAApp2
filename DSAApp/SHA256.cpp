...
uint64_t sha256_easy_hash_int64(uint8_t* hash) {
    return ((uint64_t)hash[0] << 0    |
            (uint64_t)hash[1] << 8    |
            (uint64_t)hash[2] << 16   |
            (uint64_t)hash[3] << 24   |
            (uint64_t)hash[4] << 32   |
            ...
            (uint64_t)hash[11] << 88  | 
            (uint64_t)hash[12] << 96  |
            (uint64_t)hash[13] << 104 | 
            (uint64_t)hash[14] << 112 | 
            (uint64_t)hash[15] << 120 | 
            (uint64_t)hash[16] << 128 |
            (uint64_t)hash[17] << 136 |
            (uint64_t)hash[18] << 144 | 
            (uint64_t)hash[19] << 152 |
            (uint64_t)hash[20] << 160 | 
            (uint64_t)hash[21] << 168 |
            (uint64_t)hash[22] << 176 |
            (uint64_t)hash[23] << 184 | 
            (uint64_t)hash[24] << 192 | 
            (uint64_t)hash[25] << 200 | 
            (uint64_t)hash[26] << 208 |
            (uint64_t)hash[27] << 216 |
            (uint64_t)hash[28] << 224 |
            (uint64_t)hash[29] << 232 |
            (uint64_t)hash[30] << 240 |
            (uint64_t)hash[31] << 248);
}